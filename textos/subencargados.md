...
> **[CONFIRMAR — Víctor]** Antes de publicar: aceptar/firmar el DPA de OpenRouter y comprobar su política de retención y de no utilización de los datos para entrenamiento, para poder afirmarlo aquí. Ver también la nota sobre la traducción automática en `NOTAS-INTERNAS.md`.
